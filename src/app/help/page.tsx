  ...
  return (
    <main className="min-h-[100dvh] flex flex-col bg-bg">
      ...
      <section className="w-full max-w-[560px] mx-auto px-6 py-10 flex flex-col gap-7">
        ...
        <div className="space-y-2">
          <h2 className="text-[15px] font-bold tracking-tight">
            Почему сделка или объявление не проходит по сумме?
          </h2>
          <p className="text-[14px] text-text-2 leading-relaxed">
            На öz действуют лимиты. Пока у участника менее трёх завершённых
            сделок, каждая его сделка ограничена эквивалентом 500 000 ₸ — так
            новые аккаунты не могут сразу двигать большие суммы. И для всех
            без исключения есть дневной лимит: не больше эквивалента
            2 500 000 ₸ на человека в день — с запасом ниже порога в 5 000
            долларов США, после которого корейский закон требует отчётности.
            Если упёрлись в лимит, разбейте сумму на несколько дней или
            выберите сделку поменьше. Подробнее — в{" "}
            <Link
              href="/terms"
